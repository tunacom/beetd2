...
var AutoBuildTemplate = {
  ...
  12:  {
    SkillPoints: [107, 109, 110],  // charge, cleansing, resist lightning
    StatPoints: [3, 3, 3, 3, 3],
    Update: function () {
      Config.PickitFiles = ["beetd2/tuna.nip", "beetd2/class/hammer.nip", "beetd2/low_level_additions.nip"];
      Config.AttackSkill = [-1, 0, 110, 0, 110, -1, -1];
    }
  },
  ...
  18:  {
    SkillPoints: [112, 115, 108],  // blessed hammer, vigor, blessed aim
    StatPoints: [3, 3, 3, 3, 3],
    Update: function () {
      Config.AttackSkill = [-1, 112, 110, 112, 110, -1, -1];
      Config.LowManaSkill = [0, 110];
    }
  },

  19:  {
    SkillPoints: [112, 115],  // blessed hammer, vigor
    StatPoints: [3, 3, 3, 3, 3],
    Update: function () {
  ...
  30:  {
    ...
    StatPoints: [0, 0, 0, 0, 0],
    Update: function () {
      Config.AttackSkill = [-1, 112, 125, 112, 125, -1, -1];
    }
  },
