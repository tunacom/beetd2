...
var AutoBuildTemplate = {
  ...
  2:  {
    ...
    Update: function () {
      Config.AttackSkill = [-1, 38, -1, 38, -1, -1, -1];
    }
  },
  ...
  12:  {
    ...
    StatPoints: [3, 3, 3, 3, 3],
    Update: function () {
      Config.PickitFiles = ["beetd2/tuna.nip", "beetd2/class/light.nip", "beetd2/low_level_additions.nip"];
      Config.AttackSkill = [-1, 49, -1, 38, -1, -1, -1];
    }
  },
  ...
  18:  {
    SkillPoints: [54, 53],  // teleport, chain lightning
    StatPoints: [3, 3, 3, 3, 3],
    Update: function () {
  ...
  40:  {
    ...
    StatPoints: [3, 3, 3, 3, 3],
    Update: function () {
      Config.PickitFiles = ["beetd2/tuna.nip", "beetd2/class/light.nip"];
    }
  },
